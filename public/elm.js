...
var author$project$Model$setSlide = F2(
	function (slide, model) {
		return _Utils_update(
			model,
			{slide: slide});
	});
var author$project$Slide$SlideDoesntExist = {$: 'SlideDoesntExist'};
var author$project$Slide$FromRoute = function (a) {
	return {$: 'FromRoute', a: a};
};
var author$project$Slide$fromRoute = author$project$Slide$FromRoute;
...
var author$project$Main$handleRoute = function (maybeRoute) {
	if (maybeRoute.$ === 'Nothing') {
		return author$project$Model$setSlide(author$project$Slide$SlideDoesntExist);
	} else {
		var route = maybeRoute.a;
		return author$project$Model$setSlide(
			author$project$Slide$fromRoute(route));
	}
};
...
var author$project$Route$toParser = function (route) {
	...
	if (route.$ === 'Title') {
		return elm$url$Url$Parser$oneOf(
			_List_fromArray(
				[
					A2(elm$url$Url$Parser$map, author$project$Route$Title, elm$url$Url$Parser$top),
					defaultParser
				]));
	} else {
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	A2(elm$core$List$map, author$project$Route$toParser, author$project$Route$allInCorrectOrder));
...
var author$project$Main$init = F3(
	function (_n0, url, key) {
		var initialSlide = A2(
			...
			author$project$Slide$SlideDoesntExist,
			A2(
				elm$core$Maybe$map,
				author$project$Slide$fromRoute,
				author$project$Route$fromUrl(url)));
		return author$project$Util$Cmd$withNoCmd(
			A2(
				author$project$Main$handleRoute,
				author$project$Route$fromUrl(url),
				A2(author$project$Model$init, initialSlide, key)));
	});
var author$project$Msg$SecondElapsed = {$: 'SecondElapsed'};
var author$project$Msg$LeftPressed = {$: 'LeftPressed'};
var author$project$Msg$RightPressed = {$: 'RightPressed'};
var elm$json$Json$Decode$andThen = _Json_andThen;
var elm$json$Json$Decode$fail = _Json_fail;
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Msg$arrowKeyDecoder = function () {
	var decoderFromString = function (str) {
		switch (str) {
			case 'ArrowLeft':
				return elm$json$Json$Decode$succeed(author$project$Msg$LeftPressed);
			case 'ArrowRight':
				return elm$json$Json$Decode$succeed(author$project$Msg$RightPressed);
			default:
				return elm$json$Json$Decode$fail('Not an arrow key');
		}
	};
	return A2(elm$json$Json$Decode$andThen, decoderFromString, elm$json$Json$Decode$string);
}();
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2(elm$json$Json$Decode$field, 'key', author$project$Msg$arrowKeyDecoder)),
				A2(
				elm$time$Time$every,
				1000,
				elm$core$Basics$always(author$project$Msg$SecondElapsed))
			]));
};
var author$project$Audio$playAudio = _Platform_outgoingPort('playAudio', elm$core$Basics$identity);
var author$project$Audio$toFilePathBase = function (audio) {
	switch (audio.$) {
		case 'SineWaveDemo':
			return 'sine-wave-demo';
		case 'IdealFlute':
			return 'ideal-flute';
		case 'IdealFlute__SineWave':
			return 'flute-tone';
		case 'ElmVoice':
			return 'elm-voice';
		case 'ElmVoice__E':
		...
		case 'ElmVoice__Uh':
			return 'elm-voice-uh';
		case 'ElmVoice__AllTogether':
			return 'elm-voice-all-together';
		case 'ActualSnareDrum':
			return 'marching-snare-drum';
		default:
			return 'elm-europe-snare-final';
	}
};
var author$project$Audio$toFilePath = function (audio) {
	return './' + (author$project$Audio$toFilePathBase(audio) + '.mp3');
};
...
var author$project$Audio$play = F2(
	function (htmlId, audio) {
		return author$project$Audio$playAudio(
			elm$json$Json$Encode$object(
				_List_fromArray(
					[
						...
						elm$core$Tuple$pair,
						'htmlId',
						elm$json$Json$Encode$string(htmlId)),
						A2(
						elm$core$Tuple$pair,
						'filePath',
						elm$json$Json$Encode$string(
							author$project$Audio$toFilePath(audio)))
					])));
	});
...
var author$project$Route$goTo = function (key) {
	return A2(
		...
		author$project$Route$toUrlString,
		elm$browser$Browser$Navigation$pushUrl(key));
};
var author$project$Route$prev = function (route) {
	var getNextHelper = function (remainingRoutes) {
		getNextHelper:
		while (true) {
			if (remainingRoutes.b && remainingRoutes.b.b) {
				var first = remainingRoutes.a;
				var _n1 = remainingRoutes.b;
				var second = _n1.a;
				var rest = _n1.b;
				if (_Utils_eq(second, route)) {
					return first;
				} else {
					var $temp$remainingRoutes = A2(elm$core$List$cons, second, rest);
					remainingRoutes = $temp$remainingRoutes;
					continue getNextHelper;
				}
			} else {
				return author$project$Route$Title;
			}
		}
	};
	return getNextHelper(author$project$Route$allInCorrectOrder);
};
var author$project$Slide$toRoute = function (slide) {
	if (slide.$ === 'FromRoute') {
		var route = slide.a;
		return route;
	} else {
...
var author$project$Slide$prev = A2(elm$core$Basics$composeL, author$project$Route$prev, author$project$Slide$toRoute);
var author$project$Model$digress = function (model) {
	return A2(
		author$project$Route$goTo,
		model.navKey,
		author$project$Slide$prev(model.slide));
};
var author$project$Model$incrementSecond = function (model) {
	return _Utils_update(
		model,
		{time: model.time + 1});
};
var author$project$Route$next = function (route) {
	var getNextHelper = function (remainingRoutes) {
		getNextHelper:
		while (true) {
			if (remainingRoutes.b && remainingRoutes.b.b) {
				...
				return author$project$Route$End;
			}
		}
	};
	return getNextHelper(author$project$Route$allInCorrectOrder);
};
var author$project$Slide$next = A2(elm$core$Basics$composeL, author$project$Route$next, author$project$Slide$toRoute);
var author$project$Model$progress = function (model) {
	return A2(
		author$project$Route$goTo,
		model.navKey,
		author$project$Slide$next(model.slide));
};
	...
	function (msg, model) {
		switch (msg.$) {
			case 'RouteChanged':
				...
				return author$project$Util$Cmd$withNoCmd(
					A2(author$project$Main$handleRoute, maybeRoute, model));
			case 'UrlRequested':
				return author$project$Util$Cmd$withNoCmd(model);
			case 'LeftPressed':
				return _Utils_Tuple2(
					model,
					author$project$Model$digress(model));
			case 'RightPressed':
				return _Utils_Tuple2(
					model,
					author$project$Model$progress(model));
			case 'PlayClicked':
				var audio = msg.a;
				return _Utils_Tuple2(
					model,
					A2(author$project$Audio$play, model.audioPlayerHtmlId, audio));
			case 'SecondElapsed':
				return author$project$Util$Cmd$withNoCmd(
					author$project$Model$incrementSecond(model));
			default:
				return _Utils_Tuple2(
					model,
					A2(author$project$Route$goTo, model.navKey, author$project$Route$Title));
		}
	});
...
var Chadtech$elm_css_grid$Html$Grid$columnStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var Chadtech$elm_css_grid$Html$Grid$column = function (styles) {
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						Chadtech$elm_css_grid$Html$Grid$columnStyle,
...
var Chadtech$elm_css_grid$Html$Grid$rowStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			rtfeldman$elm_css$Css$displayFlex,
			rtfeldman$elm_css$Css$flexDirection(rtfeldman$elm_css$Css$row)
		]));
var Chadtech$elm_css_grid$Html$Grid$row = function (styles) {
	return A2(
		rtfeldman$elm_css$Html$Styled$node,
		'row',
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						Chadtech$elm_css_grid$Html$Grid$rowStyle,
						rtfeldman$elm_css$Css$batch(styles)
					]))
			]));
};
var author$project$Model$doubleDigits = function (str) {
	return (elm$core$String$length(str) === 1) ? ('0' + str) : str;
};
var author$project$Model$formattedTime = function (_n0) {
	var time = _n0.time;
	return A2(
		elm$core$String$join,
		':',
		_List_fromArray(
			[
				elm$core$String$fromInt((time / 60) | 0),
				author$project$Model$doubleDigits(
...
var author$project$View$Helpers$header = function (content) {
	return A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					rtfeldman$elm_css$Css$px(author$project$Style$Units$size2)),
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										A2(author$project$View$Helpers$words, _List_Nil, 'This slide does not exist')
									]))
							])),
						A2(
						Chadtech$elm_css_grid$Html$Grid$row,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Msg$goToTitleClicked)
											]),
										'go to title slide')
									]))
							]))
...
var author$project$Style$center = A2(rtfeldman$elm_css$Css$margin2, rtfeldman$elm_css$Css$zero, rtfeldman$elm_css$Css$auto);
...
var author$project$Style$Units$size0 = 2;
...
var author$project$Style$indent = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			...
			rtfeldman$elm_css$Css$px(author$project$Style$Units$size0),
				...
				[
					...
					_List_fromArray(
						[
							...
							rtfeldman$elm_css$Css$px(author$project$Style$Units$size1)),
							rtfeldman$elm_css$Css$flexDirection(rtfeldman$elm_css$Css$column)
						]),
					_List_fromArray(
						[
...
var author$project$View$Card$containerStyle = rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			author$project$Style$outdent,
			rtfeldman$elm_css$Css$backgroundColor(Chadtech$ct_colors$Chadtech$Colors$content1),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$batch(styles),
						author$project$View$Card$containerStyle
					]))
			]));
};
...
var author$project$Main$view = function (model) {
			...
			[
				...
				_List_fromArray(
					[
						...
						'time = ' + author$project$Model$formattedTime(model))
					]))
			]));
	var mainContent = A2(
		Chadtech$elm_css_grid$Html$Grid$row,
	...
	return {
		body: A2(
			...
			_List_fromArray(
				[
					author$project$Style$globals,
					A2(
					rtfeldman$elm_css$Html$Styled$audio,
					_List_fromArray(
						[
							rtfeldman$elm_css$Html$Styled$Attributes$id(model.audioPlayerHtmlId)
						]),
					_List_Nil),
					A2(
					Chadtech$elm_css_grid$Html$Grid$row,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2(
											author$project$View$Card$body,
											_List_Nil,
											_List_fromArray(
												[mainContent, timeView]))
										]))
								]))
						]))
				])),
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		onUrlChange: A2(elm$core$Basics$composeL, author$project$Msg$RouteChanged, author$project$Route$fromUrl),
		onUrlRequest: author$project$Msg$UrlRequested,
